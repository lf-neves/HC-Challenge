  ...
  return (
    <WrapItem>
      <Box w="250px" borderWidth="1px" borderRadius="lg" overflow="hidden">
        ...
        <Box p="6">
          <Box my="2" fontWeight="semibold" as="h4" lineHeight="tight" isTruncated>
            {gif.title}
          </Box>
          <Flex alignItems="center">
            <IconButton onClick={copyURL} aria-label="copy" icon={<CopyIcon />} color={'black'} />

            <Badge ml={5} colorScheme="blue" h="fit-content">
              Rating: {gif.rating}
            </Badge>
          </Flex>
        </Box>
